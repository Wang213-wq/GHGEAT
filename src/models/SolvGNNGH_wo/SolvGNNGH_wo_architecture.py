...
class SolvGNNGH_wo(nn.Module):
    def __init__(self, in_dim, hidden_dim, n_classes=1):
        super(SolvGNNGH_wo, self).__init__()
        ...
        # MLP for A
        self.mlp1a = nn.Linear(hidden_dim*2, hidden_dim)
        self.mlp2a = nn.Linear(hidden_dim, hidden_dim)
        self.mlp3a = nn.Linear(hidden_dim, n_classes)
        
        # MLP for B
        self.mlp1b = nn.Linear(hidden_dim*2, hidden_dim)
